    ...
    public class SzczegolyUslugiController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            var szczegoly = await _context.SzczegolyUslugi
                                        ...
                                        .OrderBy(s => s.Usluga.Nazwa)
                                        .ThenBy(s => s.Pracownik.Nazwisko)
                                        .ThenBy(s => s.Pracownik.Imie)
                                        .ThenBy(s => s.Opis)
                                        .AsNoTracking()
                                        .ToListAsync();
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            if (szczegolyUslugi == null) return NotFound();
        ...
        public IActionResult Create()
        {
            ...
            ViewData["UslugaId"] = new SelectList(_context.Set<Usluga>(), "IdUslugi", "Nazwa");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("IdSzczegolowUslugi,Opis,Cena, CzasTrwaniaMinuty,UslugaId,PracownikId")] SzczegolyUslugi szczegolyUslugi)
        {
            ...
            ViewData["UslugaId"] = new SelectList(_context.Set<Usluga>(), "IdUslugi", "Nazwa", szczegolyUslugi.UslugaId);
            return View(szczegolyUslugi);
        }
