...
namespace BookLocal.API.Interfaces
{
    public interface IMessagesService
    {
        ...
        Task<(bool Success, IEnumerable<MessageDto>? Data, string? ErrorMessage, int StatusCode)> GetMessagesAsync(int conversationId, int pageNumber, int pageSize, ClaimsPrincipal user);
